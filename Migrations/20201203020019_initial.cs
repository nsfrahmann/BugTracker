        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerData = table.Column<byte[]>(nullable: true),
                    BannerContentType = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Created = table.Column<DateTime>(nullable: false),
                    Updated = table.Column<DateTime>(nullable: true),
                    ProjectUserIds = table.Column<List<string>>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TicketId = table.Column<int>(nullable: false),
                    DeveloperAssigned = table.Column<string>(nullable: true),
                    OldDeveloperValue = table.Column<string>(nullable: true),
                    NewDeveloperValue = table.Column<string>(nullable: true),
                    TicketTitle = table.Column<string>(nullable: true),
                    OldTitleValue = table.Column<string>(nullable: true),
                    NewTitleValue = table.Column<string>(nullable: true),
                    TicketDescription = table.Column<string>(nullable: true),
                    OldDescriptionValue = table.Column<string>(nullable: true),
                    NewDescriptionValue = table.Column<string>(nullable: true),
                    TicketType = table.Column<string>(nullable: true),
                    OldTypeValue = table.Column<string>(nullable: true),
                    NewTypeValue = table.Column<string>(nullable: true),
                    TicketPriority = table.Column<string>(nullable: true),
                    OldPriorityValue = table.Column<string>(nullable: true),
                    NewPriorityValue = table.Column<string>(nullable: true),
                    TicketStatus = table.Column<string>(nullable: true),
                    OldStatusValue = table.Column<string>(nullable: true),
                    NewStatusValue = table.Column<string>(nullable: true),
                    Created = table.Column<DateTimeOffset>(nullable: false),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                name: "TicketSubComments",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TicketCommentId = table.Column<int>(nullable: false),
                    AuthorId = table.Column<string>(nullable: true),
                    Content = table.Column<string>(nullable: true),
                    Created = table.Column<DateTime>(nullable: false),
                    Updated = table.Column<DateTime>(nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketSubComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketSubComments_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketSubComments_TicketComments_TicketCommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketSubComments_AuthorId",
                table: "TicketSubComments",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketSubComments_TicketCommentId",
                table: "TicketSubComments",
